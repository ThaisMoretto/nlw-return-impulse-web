  ...
  if (screenshot) {
    return (
      <button
        ...
        style={{
          backgroundImage: `url(${screenshot})`, // aqui já estaria pronto, mas devido o widget estar no canto, adicionamos as próximas duas props para visualizar no preview
          backgroundPosition: "right bottom", // desnecessário
          backgroundSize: 180, // desnecessário
        }}
      >
        <Trash weight="fill" />
      </button>
